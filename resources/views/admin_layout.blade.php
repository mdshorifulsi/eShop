                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Manufacture<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add-manufacture')}}">Add Manufacture</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/all-manufacture')}}">All Manufacture</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                            ...
                            <!-- /.nav-second-level -->
                              ...
                              <li>
                            <a href="{{URL::to('/manage-order')}}"><i class="fa fa-edit fa-fw"></i> Manage order<span class="fa arrow"></span></a>
